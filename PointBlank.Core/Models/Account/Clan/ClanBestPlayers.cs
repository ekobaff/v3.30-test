...
// Type: PointBlank.Core.Models.Account.Clan.ClanBestPlayers
...
namespace PointBlank.Core.Models.Account.Clan
{
  public class ClanBestPlayers
  {
    ...
    public void SetBestWins(PlayerStats stats, Slot slot, bool WonTheMatch)
    {
      if (!WonTheMatch)
        return;
      ComDiv.updateDB("players", "clan_wins_pt", (object) ++stats.ClanWins, "player_id", (object) slot._playerId);
    ...
    {
      ComDiv.updateDB("players", "clan_game_pt", (object) ++stats.ClanGames, "player_id", (object) slot._playerId);
