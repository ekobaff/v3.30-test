...
// Type: PointBlank.Core.Models.Account.AccountStatus
  ...
  public class AccountStatus
  {
    ...
    public void ResetData(long player_id)
    {
      ...
      if (channelId == (int) this.channelId && roomId == (int) this.roomId && clanFid == (int) this.clanFId && serverId == (int) this.serverId)
        return;
      ComDiv.updateDB("players", "status", (object) (long) uint.MaxValue, nameof (player_id), (object) player_id);
    }
    ...
    private void UpdateDB() => ComDiv.updateDB("players", "status", (object) (long) BitConverter.ToUInt32(this.buffer, 0), "player_id", (object) this.player_id);
  }
}
