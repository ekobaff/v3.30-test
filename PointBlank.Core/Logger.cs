...
namespace PointBlank.Core
{
  public static class Logger
  {
    ...
    public static void console(string text) => Logger.write(DateTime.Now.ToString("dd/MM/yy HH:mm:ss ") + "[Console] " + text, ConsoleColor.Cyan);
    ...
    public static void unkhown_packet(string text) => Logger.write(text, ConsoleColor.Green);
