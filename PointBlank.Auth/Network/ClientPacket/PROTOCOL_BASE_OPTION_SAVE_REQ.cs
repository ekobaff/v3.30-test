...
// Type: PointBlank.Auth.Network.ClientPacket.PROTOCOL_BASE_OPTION_SAVE_REQ
...
namespace PointBlank.Auth.Network.ClientPacket
{
  public class PROTOCOL_BASE_OPTION_SAVE_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_BASE_OPTION_SAVE_REQ(AuthClient client, byte[] data) => this.makeme(client, data);
