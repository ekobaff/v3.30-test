...
// Type: PointBlank.Game.Data.Managers.ClanManager
...
namespace PointBlank.Game.Data.Managers
{
  public static class ClanManager
  {
    ...
    public static void SendPacket(PointBlank.Core.Network.SendPacket packet, List<PointBlank.Game.Data.Model.Account> players)
    {
      if (players.Count == 0)
        return;
    ...
    public static void SendPacket(PointBlank.Core.Network.SendPacket packet, List<PointBlank.Game.Data.Model.Account> players, long exception)
    {
      if (players.Count == 0)
        return;
      byte[] completeBytes = packet.GetCompleteBytes("ClanManager.SendPacket");
    ...
    public static void SendPacket(
      PointBlank.Core.Network.SendPacket packet,
      int clan_id,
      long exception,
      bool useCache,
      bool isOnline)
