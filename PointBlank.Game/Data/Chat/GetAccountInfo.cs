...
// Type: PointBlank.Game.Data.Chat.GetAccountInfo
...
namespace PointBlank.Game.Data.Chat
{
  public static class GetAccountInfo
  {
    ...
    public static string getByNick(string str, Account player) => GetAccountInfo.BaseCode(AccountManager.getAccount(str.Substring(5), 1, 2), player);
