...
// Type: PointBlank.Game.Network.ServerPacket.PROTOCOL_ROOM_GET_USER_ITEM_ACK
...
namespace PointBlank.Game.Network.ServerPacket
{
  public class PROTOCOL_ROOM_GET_USER_ITEM_ACK : SendPacket
  {
    ...
    public PROTOCOL_ROOM_GET_USER_ITEM_ACK(PointBlank.Game.Data.Model.Account p) => this.p = p;
