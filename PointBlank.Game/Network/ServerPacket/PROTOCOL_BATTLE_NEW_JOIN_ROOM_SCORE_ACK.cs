...
// Type: PointBlank.Game.Network.ServerPacket.PROTOCOL_BATTLE_NEW_JOIN_ROOM_SCORE_ACK
...
namespace PointBlank.Game.Network.ServerPacket
{
  public class PROTOCOL_BATTLE_NEW_JOIN_ROOM_SCORE_ACK : SendPacket
  {
    ...
    public PROTOCOL_BATTLE_NEW_JOIN_ROOM_SCORE_ACK(PointBlank.Game.Data.Model.Room room) => this.room = room;
