...
// Type: PointBlank.Game.Network.ServerPacket.PROTOCOL_ROOM_GET_SLOTINFO_ACK
...
namespace PointBlank.Game.Network.ServerPacket
{
  public class PROTOCOL_ROOM_GET_SLOTINFO_ACK : SendPacket
  {
    ...
    public PROTOCOL_ROOM_GET_SLOTINFO_ACK(PointBlank.Game.Data.Model.Room r) => this.room = r;
