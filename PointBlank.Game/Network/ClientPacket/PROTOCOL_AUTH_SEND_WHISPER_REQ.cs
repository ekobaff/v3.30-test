...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_AUTH_SEND_WHISPER_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_AUTH_SEND_WHISPER_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_AUTH_SEND_WHISPER_REQ(GameClient client, byte[] data) => this.makeme(client, data);
