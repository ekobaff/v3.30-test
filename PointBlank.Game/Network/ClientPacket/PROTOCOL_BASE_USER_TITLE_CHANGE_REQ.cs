...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_BASE_USER_TITLE_CHANGE_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_BASE_USER_TITLE_CHANGE_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_BASE_USER_TITLE_CHANGE_REQ(GameClient client, byte[] data) => this.makeme(client, data);
