...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CLAN_WAR_MATCH_TEAM_COUNT_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  ...
  {
    public PROTOCOL_CLAN_WAR_MATCH_TEAM_COUNT_REQ(GameClient client, byte[] data) => this.makeme(client, data);
