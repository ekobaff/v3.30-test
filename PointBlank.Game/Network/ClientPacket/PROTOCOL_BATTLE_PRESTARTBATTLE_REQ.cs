...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_BATTLE_PRESTARTBATTLE_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_BATTLE_PRESTARTBATTLE_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_BATTLE_PRESTARTBATTLE_REQ(GameClient client, byte[] data) => this.makeme(client, data);
