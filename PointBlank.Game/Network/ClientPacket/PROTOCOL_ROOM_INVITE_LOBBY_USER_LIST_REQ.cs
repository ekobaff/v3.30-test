...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_ROOM_INVITE_LOBBY_USER_LIST_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_ROOM_INVITE_LOBBY_USER_LIST_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_ROOM_INVITE_LOBBY_USER_LIST_REQ(GameClient client, byte[] data) => this.makeme(client, data);
