...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_MESSENGER_NOTE_SEND_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_MESSENGER_NOTE_SEND_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_MESSENGER_NOTE_SEND_REQ(GameClient client, byte[] data) => this.makeme(client, data);
