...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CLAN_WAR_MATCH_PROPOSE_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CLAN_WAR_MATCH_PROPOSE_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CLAN_WAR_MATCH_PROPOSE_REQ(GameClient client, byte[] data) => this.makeme(client, data);
