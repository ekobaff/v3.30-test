...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_BASE_QUEST_BUY_CARD_SET_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_BASE_QUEST_BUY_CARD_SET_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_BASE_QUEST_BUY_CARD_SET_REQ(GameClient client, byte[] data) => this.makeme(client, data);
