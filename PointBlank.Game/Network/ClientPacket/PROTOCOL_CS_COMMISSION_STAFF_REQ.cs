...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_COMMISSION_STAFF_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_COMMISSION_STAFF_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_COMMISSION_STAFF_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void read()
    {
      ...
      else
      {
        ...
        for (int index = 0; index < num; ++index)
        {
          ...
          if (account != null && account.clanId == clan._id && account.clanAccess == 3 && ComDiv.updateDB("players", "clanaccess", (object) 2, "player_id", (object) account.player_id))
          {
