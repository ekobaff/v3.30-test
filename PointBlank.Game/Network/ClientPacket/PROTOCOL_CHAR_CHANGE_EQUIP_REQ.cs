...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CHAR_CHANGE_EQUIP_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CHAR_CHANGE_EQUIP_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CHAR_CHANGE_EQUIP_REQ(GameClient Client, byte[] Buffer) => this.makeme(Client, Buffer);
    ...
    public override void run()
    {
      ...
      if (ComDiv.updateDB("players", "player_id", (object) this.Player.player_id, query.GetTables(), query.GetValues()))
