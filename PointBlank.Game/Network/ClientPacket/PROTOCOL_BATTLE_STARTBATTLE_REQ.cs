...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_BATTLE_STARTBATTLE_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  ...
  {
    public PROTOCOL_BATTLE_STARTBATTLE_REQ(GameClient client, byte[] data) => this.makeme(client, data);
