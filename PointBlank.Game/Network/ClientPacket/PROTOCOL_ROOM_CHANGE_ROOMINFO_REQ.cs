...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_ROOM_CHANGE_ROOMINFO_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  ...
  {
    public PROTOCOL_ROOM_CHANGE_ROOMINFO_REQ(GameClient client, byte[] data) => this.makeme(client, data);
