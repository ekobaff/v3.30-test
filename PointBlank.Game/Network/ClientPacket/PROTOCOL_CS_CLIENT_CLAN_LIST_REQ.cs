...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_CLIENT_CLAN_LIST_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_CLIENT_CLAN_LIST_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_CLIENT_CLAN_LIST_REQ(GameClient client, byte[] data) => this.makeme(client, data);

    public override void read() => this.page = this.readUD();
