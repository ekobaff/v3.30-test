...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_ROOM_CHANGE_SLOT_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_ROOM_CHANGE_SLOT_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_ROOM_CHANGE_SLOT_REQ(GameClient client, byte[] data) => this.makeme(client, data);
