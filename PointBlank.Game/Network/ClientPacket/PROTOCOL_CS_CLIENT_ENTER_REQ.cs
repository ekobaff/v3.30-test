...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_CLIENT_ENTER_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_CLIENT_ENTER_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_CLIENT_ENTER_REQ(GameClient client, byte[] data) => this.makeme(client, data);
