...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_AUTH_FRIEND_INVITED_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_AUTH_FRIEND_INVITED_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_AUTH_FRIEND_INVITED_REQ(GameClient client, byte[] data) => this.makeme(client, data);

    public override void read() => this.playerName = this.readUnicode(66);
