...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_ROOM_TOTAL_TEAM_CHANGE_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_ROOM_TOTAL_TEAM_CHANGE_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_ROOM_TOTAL_TEAM_CHANGE_REQ(GameClient client, byte[] data) => this.makeme(client, data);
