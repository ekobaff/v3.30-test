...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_SECESSION_CLAN_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_SECESSION_CLAN_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_SECESSION_CLAN_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    private Message CreateMessage(PointBlank.Core.Models.Account.Clan.Clan clan, PointBlank.Game.Data.Model.Account sender)
    {
      ...
      return !MessageManager.CreateMessage(clan.owner_id, msg) ? (Message) null : msg;
    }
  }
}
