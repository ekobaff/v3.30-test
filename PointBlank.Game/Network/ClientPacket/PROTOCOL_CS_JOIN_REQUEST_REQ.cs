...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_JOIN_REQUEST_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_JOIN_REQUEST_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_JOIN_REQUEST_REQ(GameClient client, byte[] data) => this.makeme(client, data);
