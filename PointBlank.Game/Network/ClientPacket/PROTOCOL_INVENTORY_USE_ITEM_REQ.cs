...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_INVENTORY_USE_ITEM_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_INVENTORY_USE_ITEM_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_INVENTORY_USE_ITEM_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void run()
    {
      try
      {
        ...
        if (itemsModel != null && itemsModel._id > 1700000)
        {
          ...
          int int64 = Convert.ToInt32(dateTime.ToString("yyMMddHHmm"));
          switch (itemId)
          {
            case 1600005:
            case 1600052:
      ...
      catch (Exception ex)
      {
        ...
        this._client.SendPacket((SendPacket) new PROTOCOL_AUTH_SHOP_ITEM_AUTH_ACK(2147483648U));
      }
    }
    ...
    private void CreateCouponEffects(int cupomId, long cuponDays, PointBlank.Game.Data.Model.Account p)
    {
      switch (cupomId)
      {
        case 1600005:
          ...
          if (clan1._id > 0 && clan1.owner_id == this._client.player_id && ComDiv.updateDB("clans", "color", (object) (int) this.value, "clan_id", (object) clan1._id))
          {
          ...
          break;
        case 1600006:
          if (ComDiv.updateDB("players", "name_color", (object) (int) this.value, "player_id", (object) p.player_id))
          {
            p.name_color = (int) this.value;
            this._client.SendPacket((SendPacket) new PROTOCOL_INVENTORY_GET_INFO_ACK(0, p, new ItemsModel(cupomId, 3, "Name Color [Active]", 2, cuponDays)));
        ...
        case 1600009:
          ...
          if (ComDiv.updateDB("player_bonus", "fakerank", (object) (int) this.value, "player_id", (object) p.player_id))
          {
            ...
            this._client.SendPacket((SendPacket) new PROTOCOL_INVENTORY_GET_INFO_ACK(0, p, new ItemsModel(cupomId, 3, "Fake Rank [Active]", 2, cuponDays)));
            if (p._room == null)
              break;
        ...
        case 1600010:
          ...
          if (ComDiv.updateDB("player_bonus", "fakenick", (object) p.player_name, "player_id", (object) p.player_id) && ComDiv.updateDB("players", "player_name", (object) this.txt, "player_id", (object) p.player_id))
          {
            ...
            this._client.SendPacket((SendPacket) new PROTOCOL_INVENTORY_GET_INFO_ACK(0, p, new ItemsModel(cupomId, 3, "Fake Nick [Active]", 2, cuponDays)));
            if (p._room == null)
              break;
            p._room.updateSlotsInfo();
            break;
        ...
        case 1600014:
          if (ComDiv.updateDB("player_bonus", "sightcolor", (object) (int) this.value, "player_id", (object) p.player_id))
          {
            ...
            this._client.SendPacket((SendPacket) new PROTOCOL_BASE_INV_ITEM_DATA_ACK(this.info.Length, p));
            this._client.SendPacket((SendPacket) new PROTOCOL_INVENTORY_GET_INFO_ACK(0, p, new ItemsModel(cupomId, 3, "Sight Color [Active]", 2, cuponDays)));
            break;
          }
          this.erro = 2147483648U;
          break;
        case 1600047:
                    ...
                    else if (!PlayerManager.isPlayerNameExist(this.txt))
                    {
                        if (ComDiv.updateDB("players", "player_name", (object)this.txt, "player_id", (object)p.player_id))
                        {
                            NickHistoryManager.CreateHistory(p.player_id, p.player_name, this.txt, "[no jogo]");
                            p.player_name = this.txt;
                            if (p._room != null)
                            {
                                using (PROTOCOL_ROOM_GET_NICKNAME_ACK roomGetNicknameAck = new PROTOCOL_ROOM_GET_NICKNAME_ACK(p._slotId, p.player_name, p.name_color))
        ...
        case 1600051:
          ...
          {
            if (!ClanManager.isClanNameExist(this.txt) && ComDiv.updateDB("clans", "clan_name", (object) this.txt, "clan_id", (object) p.clanId))
            {
        ...
        case 1600187:
          if (ComDiv.updateDB("player_bonus", "muzzle", (object) (int) this.value, "player_id", (object) p.player_id))
          {
            ...
            this._client.SendPacket((SendPacket) new PROTOCOL_BASE_INV_ITEM_DATA_ACK(this.info.Length, p));
            this._client.SendPacket((SendPacket) new PROTOCOL_INVENTORY_GET_INFO_ACK(0, p, new ItemsModel(cupomId, 3, "Muzzle Color [Active]", 2, cuponDays)));
            break;
          }
          this.erro = 2147483648U;
          break;
        case 1600193:
          ...
          {
            if (ComDiv.updateDB("clans", "effect", (object) (int) this.value, "clan_id", (object) p.clanId))
            {
        ...
        default:
          Logger.error("Coupon effect not found! Id: " + cupomId.ToString());
          this.erro = 2147483648U;
          break;
      }
    }
