...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CLAN_WAR_TEAM_CHATTING_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CLAN_WAR_TEAM_CHATTING_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CLAN_WAR_TEAM_CHATTING_REQ(GameClient client, byte[] data) => this.makeme(client, data);
