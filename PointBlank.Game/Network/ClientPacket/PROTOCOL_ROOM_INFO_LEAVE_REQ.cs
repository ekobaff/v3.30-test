...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_ROOM_INFO_LEAVE_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  ...
  {
    public PROTOCOL_ROOM_INFO_LEAVE_REQ(GameClient client, byte[] data) => this.makeme(client, data);
