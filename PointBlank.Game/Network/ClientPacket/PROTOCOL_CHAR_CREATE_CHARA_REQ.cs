...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CHAR_CREATE_CHARA_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CHAR_CREATE_CHARA_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CHAR_CREATE_CHARA_REQ(GameClient Client, byte[] Buffer) => this.makeme(Client, Buffer);
