...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_BATTLE_START_KICKVOTE_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_BATTLE_START_KICKVOTE_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_BATTLE_START_KICKVOTE_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void run()
    {
      try
      {
        ...
        if (RedPlayers < 3 && BluePlayers == 1 || BluePlayers < 3 && RedPlayers == 1)
          this.erro = 2147487970U;
