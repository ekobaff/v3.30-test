...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_DEPORTATION_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_DEPORTATION_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_DEPORTATION_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void read()
    {
      ...
      else
      {
        ...
        for (int index = 0; index < num; ++index)
        {
          ...
          {
            if (ComDiv.updateDB("players", "player_id", (object) account.player_id, new string[4]
            {
              "clan_id",
              "clanaccess",
              "clan_game_pt",
