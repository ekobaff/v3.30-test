...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_BASE_PLAYTIME_REWARD_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_BASE_PLAYTIME_REWARD_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_BASE_PLAYTIME_REWARD_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void run()
    {
      try
      {
        ...
        this._client.SendPacket((SendPacket) new PROTOCOL_INVENTORY_GET_INFO_ACK(0, player, new ItemsModel(good._item._id, good._item._category, "PlayTime Reward", good._item._equip, rewardCount)));
      }
      catch (Exception ex)
      {
