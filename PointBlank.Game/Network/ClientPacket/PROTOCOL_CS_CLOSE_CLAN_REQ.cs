...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_CLOSE_CLAN_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_CLOSE_CLAN_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_CLOSE_CLAN_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void run()
    {
      try
      {
        ...
        if (player != null)
        {
          ...
          if (clan._id > 0 && clan.owner_id == this._client.player_id && ComDiv.deleteDB("clans", "clan_id", (object) clan._id))
          {
            if (ComDiv.updateDB("players", "player_id", (object) player.player_id, new string[4]
            {
              "clan_id",
              "clanaccess",
              "clan_game_pt",
