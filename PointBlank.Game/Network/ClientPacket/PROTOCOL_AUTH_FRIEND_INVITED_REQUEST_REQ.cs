...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_AUTH_FRIEND_INVITED_REQUEST_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_AUTH_FRIEND_INVITED_REQUEST_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_AUTH_FRIEND_INVITED_REQUEST_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    private PointBlank.Game.Data.Model.Account GetFriend(PointBlank.Game.Data.Model.Account p)
    {
      ...
      return friend == null ? (PointBlank.Game.Data.Model.Account) null : AccountManager.getAccount(friend.player_id, 32);
    }
  }
}
