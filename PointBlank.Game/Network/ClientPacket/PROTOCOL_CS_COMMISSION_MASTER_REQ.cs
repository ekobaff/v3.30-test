...
// Type: PointBlank.Game.Network.ClientPacket.PROTOCOL_CS_COMMISSION_MASTER_REQ
...
namespace PointBlank.Game.Network.ClientPacket
{
  public class PROTOCOL_CS_COMMISSION_MASTER_REQ : ReceivePacket
  {
    ...
    public PROTOCOL_CS_COMMISSION_MASTER_REQ(GameClient client, byte[] data) => this.makeme(client, data);
    ...
    public override void run()
    {
      try
      {
        ...
        else if (account._rank > 10)
        {
          ...
          if (clan._id > 0 && clan.owner_id == this._client.player_id && account.clanAccess == 2 && ComDiv.updateDB("clans", "owner_id", (object) this.memberId, "clan_id", (object) clanId) && ComDiv.updateDB("players", "clanaccess", (object) 1, "player_id", (object) this.memberId) && ComDiv.updateDB("players", "clanaccess", (object) 2, "player_id", (object) player.player_id))
          {
